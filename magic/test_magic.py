...
class TestCardConvertManaCost(unittest.TestCase):
    def setUp(self):
        self.card = magic.Card("Test Card")
...
class TestDeck(unittest.TestCase):
    def setUp(self):
        self.mydeck = magic.Deck()

    def test_addOneCard(self):
        self.mydeck.add(magic.Card("Serra Angel"))
        self.assertEqual(1, len(self.mydeck))

    def test_addTwoCards(self):
        self.mydeck.add(magic.Card("Serra Angel"))
        self.mydeck.add(magic.Card("Plains"))
...
class TestDeckColorPercentageBreakdown(unittest.TestCase):
    def setUp(self):
        ...
        self.card1 = _Card("Cancel", "B")
        self.card2 = _Card("Serra Angel", "W")
    ...
    def test_emptyDeck(self):
        colors = magic.Deck().colorBreakdown()
...
class TestManaColorCount(unittest.TestCase):
    def setUp(self):
        ...
        class _Card(object):
            def __init__(self, title, manaCost):
                self.title = title
                self.manaCost = manaCost

        self.card1 = _Card("Cancel", "1BB")
        self.card2 = _Card("Serra Angel", "3WW")
...
class TestManaCurve(unittest.TestCase):
    def setUp(self):
        ...
        class _Card(object):
            def __init__(self, title, manaCost):
                self.title = title
                self.convertedManaCost = manaCost

        self.card1 = _Card("Cancel", 3)
        self.card2 = _Card("Serra Angel", 5)
